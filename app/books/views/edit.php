            ...
            <div class="tab-pane fade show active" id="nav-book" role="tabpanel"> 
                <div class="row">
                    <div class="col-9">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="book-isbn" class="form-control" id="isbn-book" required placeholder="XXX-X-XX-XXXXXX-X" disabled> 
                        </div> 
                        <div class="form-group">
                            <label for="pages-book">Cantidad de páginas</label>
                            <input type="number" name="book-pages" class="form-control" id="pages-book" required placeholder="Ingresar cantidad de páginas" disabled> 
                        </div> 
                    </div> 
                    <div class="col-3">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="form-group col-6">
                        ...
                        <input  type="text" name="book-year" id="year-book" class="form-control" placeholder="Ingresar año de publicación" disabled> 
                    </div>  
                    <div class="form-group col-6">
                        <label for="vol-book">Volumen</label>
                        <input type="text" name="book-vol" id="vol-book" class="form-control" placeholder="Ingresar número de volumen" disabled> 
                    </div> 
                </div>
                <div class="row">
                    <div class="form-group col-6">
                        <label for="languaje-book">Idioma</label>
                        <select name="book-languaje"  class="form-control" id="languaje-book" disabled>	
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="book-desc" id="desc-book" rows="3" required placeholder="Ingresar una descripción del libro" disabled></textarea> 
                </div>   
            </div>
            <!-- Datos de Autor -->
            ...
            <div class="tab-pane fade" id="nav-editorial" role="tabpanel">
                ...
                <div class="row">
                    <div class="form-group col-6">
                        ...
                        <select name="book-topic" class="form-control" id="topic-book" data-url="<?php echo URL_ROUTE?>subtopics/show" disabled>	
