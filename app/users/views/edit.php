    ...
    <form method="post" action="<?php echo URL_ROUTE ?>users/store" target="_top"  enctype="multipart/form-data">
        <div class="row">
            <div class="col-9">
                <div class="form-group">
                    ...
                    <input type="text" name="user-name" class="form-control" id="name-user" required placeholder="Ingresar nombre" disabled> 
                </div> 
                <div class="form-group">
                    <label for="lastname-user">Apellido</label>
                    <input type="text" name="user-lastname" class="form-control" id="lastname-user" required placeholder="Ingresar apellido" disabled> 
                </div> 
                <div class="form-group">
                    <label for="email-user">Email</label>
        ...
        <div class="row">
            <div class="form-group col-6">
                ...
                <input type="text" name="user-doc" id="doc-user" class="form-control" placeholder="Ingresar número de documento" required onkeyup="copyOnPassword(event);" disabled> 
